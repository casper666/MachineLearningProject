...
# Output: 3 outputs.
# 1st is the song/artist dictionary file;
# 2nd is user_song/user_artist train matrix;
# 3rd is user_song/user_artist test matrix
# need tune the parameters to statistic song OR artists!
# Our neighborhood model and the pre processing program for LFM need output of this program.
*/
...
public class dataProcess{
    ...
    public static void main(String args[]) throws IOException {
        ...
        if(property == 3) System.out.println("There are all " + map.size() + " artists.");
        else System.out.println("There are all " + map.size() + " songs.");
        //get top artistNumber artists/songs, save in artistMap
